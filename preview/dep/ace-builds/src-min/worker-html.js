            ...
            function (e, t, n) {
                function r(e) {
                    if (e.namespaceURI === 'http://www.w3.org/1999/xhtml')
                        return e.localName === 'applet' || e.localName === 'caption' || e.localName === 'marquee' || e.localName === 'object' || e.localName === 'table' || e.localName === 'td' || e.localName === 'th';
                    if (e.namespaceURI === 'http://www.w3.org/1998/Math/MathML')
                        return e.localName === 'mi' || e.localName === 'mo' || e.localName === 'mn' || e.localName === 'ms' || e.localName === 'mtext' || e.localName === 'annotation-xml';
                ...
                l.prototype._inScope = function (e, t) {
                    ...
                    for (var t = this.elements.length - 1; t >= 0; t--)
                        if (this.elements[t].localName == e)
                            return t;
                    return -1;
                ...
                f.consumeEntity = function (e, t, n) {
                    ...
                    default:
                        if (e >= 55296 && e <= 57343 || e > 1114111)
                            return 65533;
                        if (e >= 1 && e <= 8 || e >= 14 && e <= 31 || e >= 127 && e <= 159 || e >= 64976 && e <= 65007 || e == 11 || e == 65534 || e == 131070 || e == 3145726 || e == 196607 || e == 262142 || e == 262143 || e == 327678 || e == 327679 || e == 393214 || e == 393215 || e == 458750 || e == 458751 || e == 524286 || e == 524287 || e == 589822 || e == 589823 || e == 655358 || e == 655359 || e == 720894 || e == 720895 || e == 786430 || e == 786431 || e == 851966 || e == 851967 || e == 917502 || e == 917503 || e == 983038 || e == 983039 || e == 1048574 || e == 1048575 || e == 1114110 || e == 1114111)
                            return e;
                    }
                }, n.EntityParser = f;
            },
            ...
            function (e, t, n) {
                ...
                function g() {
                    ...
                    t.base = {
                        ...
                        e.insertDoctype(t || '', n || '', r || ''), i || t != 'html' || n != null && ([
                            ...
                            'html'
                        ].indexOf(n.toLowerCase()) > -1 || r == null && [
                            '-//w3c//dtd html 4.01 transitional//',
                            '-//w3c//dtd html 4.01 frameset//'
                        ].some(s)) || r != null && r.toLowerCase() == 'http://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd' ? (e.compatMode = 'quirks', e.parseError('quirky-doctype')) : n != null && ([
                            '-//w3c//dtd xhtml 1.0 transitional//',
                            '-//w3c//dtd xhtml 1.0 frameset//'
                        ].some(s) || r != null && [
                            '-//w3c//dtd html 4.01 transitional//',
                            '-//w3c//dtd html 4.01 frameset//'
                        ].indexOf(n.toLowerCase()) > -1) ? (e.compatMode = 'limited quirks', e.parseError('almost-standards-doctype')) : n == '-//W3C//DTD HTML 4.0//EN' && (r == null || r == 'http://www.w3.org/TR/REC-html40/strict.dtd') || n == '-//W3C//DTD HTML 4.01//EN' && (r == null || r == 'http://www.w3.org/TR/html4/strict.dtd') || n == '-//W3C//DTD XHTML 1.0 Strict//EN' && r == 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd' || n == '-//W3C//DTD XHTML 1.1//EN' && r == 'http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd' || (r != null && r != 'about:legacy-compat' || n != null) && e.parseError('unknown-doctype'), e.setInsertionMode('beforeHTML');
                        ...
                        if (!p(n.characters))
                            return e.parseError('unexpected-char-after-body'), e.setInsertionMode('inBody'), e.insertionMode.processCharacters(n);
                        ...
                        [
                            ...
                            'style',
                            'script'
                        ].indexOf(t) != -1 && (e.parseError('expected-named-closing-tag-but-got-eof', { name: t }), e.popElement()), this.anythingElse(), e.insertionMode.processEOF();
                        ...
                        if ([
                                ...
                                'ul',
                                'var'
                            ].indexOf(t) != -1 || t == 'font' && n.some(function (e) {
                                return [
                                    'color',
                                    'face',
                                    'size'
                                ].indexOf(e.nodeName) >= 0;
                            })) {
                ...
                m.prototype.skipAtMostOneLeadingNewline = function () {
                    ...
                    while (s++ < t) {
                        ...
                        if (!this.openElements.contains(r))
                            return this.parseError('adoption-agency-1.2', { name: e }), this.removeElementFromActiveFormattingElements(r), !0;
                        ...
                        if (!o)
                            return this.openElements.remove_openElements_until(i), this.removeElementFromActiveFormattingElements(r), !0;
                    ...
                    [
                        ...
                        'rp',
                        'rt'
                    ].indexOf(t) != -1 && t != e && (this.popElement(), this.generateImpliedEndTags(e));
                    ...
                    var t = 3;
                    if (this.activeFormattingElements.length < t)
                        return;
                    ...
                    for (var i = this.activeFormattingElements.length - 1; i >= 0; i--) {
                        ...
                        if (s === l)
                            break;
                        if (e.localName !== s.localName || e.namespaceURI !== s.namespaceURI)
                            continue;
                        if (s.attributes.length != r)
                            continue;
                        n.push(s);
                    }
                    if (n.length < t)
                    ...
                    for (var n = this.openElements.length - 1; n >= 0; n--) {
                        ...
                        if (t.namespaceURI === 'http://www.w3.org/1999/xhtml') {
                            ...
                            if (t.localName === 'html')
                                return this.openElements.headElement ? this.setInsertionMode('afterHead') : this.setInsertionMode('beforeHead');
                        }
                        if (e)
                            return this.setInsertionMode('inBody');
                    }
            ...
            function (e, t, n) {
                ...
                r.inherits(s, i), s.prototype.start = function (e) {
                    ...
                    if (this.redirectAttachToFosterParent && this.openElements.top.isFosterParenting()) {
                        ...
                        if (t === 0)
                            return this.appendCharacters(r, e);
                ...
                (function (t, r) {
                    ...
                    function c(e, t, r) {
                        ...
                        if (o.length !== 0 || !!y && t.length != 0) {
                            if (r < 0)
                                return N(t) ? e.stylize(RegExp.prototype.toString.call(t), 'regexp') : e.stylize('[Object]', 'special');
                            e.seen.push(t);
                            var E;
