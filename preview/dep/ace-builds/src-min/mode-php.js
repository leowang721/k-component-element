...
define('ace/mode/doc_comment_highlight_rules', [
    ...
    r.inherits(m, i), function () {
        this.tokenRe = new RegExp('^[' + h.packages.L + h.packages.Mn + h.packages.Mc + h.packages.Nd + h.packages.Pc + '_]+', 'g'), this.nonTokenRe = new RegExp('^(?:[^' + h.packages.L + h.packages.Mn + h.packages.Mc + h.packages.Nd + h.packages.Pc + '_]|s])+', 'g'), this.lineCommentStart = [
            '//',
            '#'
        ], this.blockComment = {
            start: '/*',
