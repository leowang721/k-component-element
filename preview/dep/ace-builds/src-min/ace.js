(function () {
    ...
    var r = e('../lib/event'), i = e('../lib/useragent'), s = e('../lib/dom'), o = e('../lib/lang'), u = i.isChrome < 18, a = i.isIE, f = function (e, t) {
            ...
            var f = '\x01\x01', l = !1, c = !1, h = !1, p = '', d = !0;
            try {
    ...
    var r = e('../lib/event'), i = e('../lib/useragent'), s = e('./default_handlers').DefaultHandlers, o = e('./default_gutter_handler').GutterHandler, u = e('./mouse_event').MouseEvent, a = e('./dragdrop_handler').DragdropHandler, f = e('../config'), l = function (e) {
            ...
            r.addListener(u, 'click', this.onMouseEvent.bind(this, 'click')), r.addListener(u, 'mousemove', this.onMouseMove.bind(this, 'mousemove')), r.addMultiMouseDownListener(u, [
                400,
                300,
                250
                ...
                300,
                250
            ], this, 'onMouseEvent'), i.isIE && (r.addListener(e.renderer.scrollBarV.element, 'mousedown', n), r.addListener(e.renderer.scrollBarH.element, 'mousedown', n))), r.addMouseWheelListener(e.container, this.onMouseWheel.bind(this, 'mousewheel'));
    ...
    'use strict';
    var r = e('./config'), i = 2000, s = function (e) {
    ...
    function u() {
        this.getFoldAt = function (e, t, n) {
            ...
            if (t.siblings) {
                ...
                t.children ? (f = o ? o.end.row : this.getLength(), this.foldAll(e + 1, f, t.all ? 10000 : 0)) : o && (t.all && (o.collapseChildren = 10000), this.addFold('...', o));
            return o;
    ...
    (function () {
        this.set = function (e) {
            ...
            var i;
            if (t.$isMultiLine)
                var o = n.length, u = function (t, r, u) {
                        var a = t.search(n[0]);
                        if (a == -1)
                            return;
                        for (var f = 1; f < o; f++) {
        ...
        this.$padding = 0, this.setPadding = function (e) {
            ...
            for (var n in this.markers) {
                ...
                if (r.renderer) {
                    ...
                    r.type == 'fullLine' ? this.drawFullLineMarker(t, i, r.clazz, e) : r.type == 'screenLine' ? this.drawScreenLineMarker(t, i, r.clazz, e) : i.isMultiLine() ? r.type == 'text' ? this.drawTextMarker(t, i, r.clazz, e) : this.drawMultiLineMarker(t, i, r.clazz, e) : this.drawSingleLineMarker(t, i, r.clazz + ' ace_start', e);
            }
            ...
            for (o = t.start.row + 1; o < t.end.row; o++)
                a.start.row = o, a.start.column = u.getRowWrapIndent(o), a.end.row = o, a.end.column = u.getScreenLastRowColumn(o), this.drawSingleLineMarker(e, a, n, i, 1, s);
    ...
    (function () {
        r.implement(this, u), this.EOF_CHAR = '\xB6', this.EOL_CHAR_LF = '\xAC', this.EOL_CHAR_CRLF = '\xA4', this.EOL_CHAR = this.EOL_CHAR_LF, this.TAB_CHAR = '\u2192', this.SPACE_CHAR = '\xB7', this.$padding = 0, this.$updateEolChar = function () {
            ...
            for (var n = 1; n < e + 1; n++)
                this.showInvisibles ? t.push('<span class=\'ace_invisible ace_invisible_tab\'>' + this.TAB_CHAR + s.stringRepeat(' ', n - 1) + '</span>') : t.push(s.stringRepeat(' ', n));
    ...
    var r = e('../lib/dom'), i, s = function (e) {
            this.element = r.createElement('div'), this.element.className = 'ace_layer ace_cursor-layer', e.appendChild(this.element), i === undefined && (i = 'opacity' in this.element), this.isVisible = !1, this.isBlinking = !0, this.blinkInterval = 1000, this.smoothBlinking = !1, this.cursors = [], this.cursor = this.addCursor(), r.addCssClass(this.element, 'ace_hidden-cursors'), this.$updateCursors = this.$updateVisibility.bind(this);
        };
    (function () {
    ...
    (function () {
        this.CHANGE_CURSOR = 1, this.CHANGE_MARKER = 2, this.CHANGE_GUTTER = 4, this.CHANGE_SCROLL = 8, this.CHANGE_LINES = 16, this.CHANGE_TEXT = 32, this.CHANGE_SIZE = 64, this.CHANGE_MARKER_BACK = 128, this.CHANGE_MARKER_FRONT = 256, this.CHANGE_FULL = 512, this.CHANGE_H_SCROLL = 1024, r.implement(this, v), this.updateCharacterSize = function () {
            ...
            if (f || h)
                w = this.$updateCachedSize(!0, this.gutterWidth, t.width, t.height), this._signal('scrollbarVisibilityChanged'), h && (u = this.$getLongestLine());
    ...
    function o(e) {
        ...
        if (l.$mouseHandler.$enableJumpToDef)
            u && n || a && n ? S = 'add' : n && l.$blockSelectEnabled && (S = 'block');
        else if (a && !n) {
            S = 'add';
            if (!h && o)
                return;
    ...
    t.showErrorMarker = function (e, t) {
        ...
        }, e.keyBinding.addKeyboardHandler(m), e.on('changeSelection', h.destroy), e.on('changeSession', h.destroy), e.on('mouseup', h.destroy), e.on('change', h.destroy), e.session.widgetManager.addLineWidget(h), h.el.onmousedown = e.focus.bind(e), e.renderer.scrollCursorIntoView(null, 0.5, { bottom: h.el.offsetHeight });
