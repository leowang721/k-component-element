...
define('ace/keyboard/vim', [
    ...
    function St(e, t, n, r) {
        ...
        for (var u = 0; u < t.length; u++) {
            var a = t[u];
            if (n == 'insert' && a.context != 'insert' || a.context && a.context != n || r.operator && a.type == 'action' || !(i = xt(e, a.keys)))
                continue;
    ...
    function Rt(e, t, n) {
        ...
        return Lt(n, t) && (o = n, n = t, t = o), Lt(i, s) ? (i = At(t, i), s = Ot(s, n)) : (s = At(t, s), i = Ot(i, n), i = wt(i, 0, -1), i.ch == -1 && i.line != e.firstLine() && (i = w(i.line - 1, _t(e, i.line - 1)))), [
            s,
            i
        ];
    }
    ...
    function zt(e, t, n, r) {
        ...
        if (n == 'char') {
            ...
            return i = wt(t.head, 0, o), s = wt(t.anchor, 0, u), {
                ranges: [{
                        anchor: s,
                        head: i
                    }],
    ...
    function Vt(e, t, n) {
        ...
        if (/\n\s*$/.test(r)) {
            ...
            i.pop();
            var s;
            for (var s = i.pop(); i.length > 0 && s && X(s); s = i.pop())
                n.line--, n.ch = 0;
    ...
    function kn(e, t) {
        ...
        if (!r || t != r.query)
            r && e.removeOverlay(r), r = Cn(t), e.addOverlay(r), e.showMatchesOnScrollbar && (n.getScrollbarAnnotate() && n.getScrollbarAnnotate().clear(), n.setScrollbarAnnotate(e.showMatchesOnScrollbar(t))), n.setOverlay(r);
    }
    function Ln(e, t, n, r) {
    ...
    function jn(e) {
        ...
        if (!i) {
            ...
            while (f < a.length)
                o.push(a[f]), a[f] instanceof Jn ? f++ : f += u;
    ...
    function tr(e) {
        ...
        return Object.keys(e).forEach(function (n) {
            ...
            head: e.sel.head && Ct(e.sel.head),
            anchor: e.sel.anchor && Ct(e.sel.anchor)
        }), t;
    }
    function nr(e, t, n) {
    ...
    y.prototype = {
        ...
        v.defineExtension('openDialog', function (t, n, r) {
            ...
            if (a)
                r.value && (a.value = r.value, r.select !== !1 && a.select()), r.onInput && v.on(a, 'input', function (e) {
                    r.onInput(e, a.value, u);
                }), r.onKeyUp && v.on(a, 'keyup', function (e) {
                    r.onKeyUp(e, a.value, u);
                }), v.on(a, 'keydown', function (e) {
                    if (r && r.onKeyDown && r.onKeyDown(e, a.value, u))
                        return;
                    if (e.keyCode == 27 || r.closeOnEnter !== !1 && e.keyCode == 13)
                        a.blur(), v.e_stop(e), u();
                    e.keyCode == 13 && n(a.value);
                }), r.closeOnBlur !== !1 && v.on(a, 'blur', u), a.focus();
            else if (f = i.getElementsByTagName('button')[0])
                v.on(f, 'click', function () {
                    u(), o.focus();
                }), r.closeOnBlur !== !1 && v.on(f, 'blur', u), f.focus();
            return u;
            ...
            if (this.virtualSelectionMode())
                return;
            e(this, u);
            var r = dialogDiv(this, t, n && n.bottom), i = !1, s, o = n && typeof n.duration != 'undefined' ? n.duration : 5000;
            return v.on(r, 'click', function (e) {
                v.e_preventDefault(e), u();
            }), o && (s = setTimeout(u, o)), u;
        });
    }();
    var b = [
            {
    ...
    var k = {
            ...
            function (e) {
                ...
                return /\S/.test(e);
            }], H = P(65, 26), B = P(97, 26), j = P(48, 10), F = [].concat(H, B, j, [
            '<',
            '>'
        ]), I = [].concat(H, B, j, [
            '-',
    ...
    var tt, rt, it = {
            ...
            findKey: function (e, t, n) {
                function i() {
                    ...
                    if (r.isRecording) {
                        if (t == 'q')
                            return r.exitMacroRecordMode(), ot(e), !0;
                        n != 'mapping' && Rn(r, t);
                    }
                }
                function s() {
                    if (t == '<Esc>')
                        return ot(e), r.visualMode ? Xt(e) : r.insertMode && jn(e), !0;
                }
                function o(n) {
                    var r;
                    while (n)
                        r = /<\w+-.+?>|<\w+>|./.exec(n), t = r[0], n = n.substring(r.index + t.length), v.Vim.handleKey(e, t, 'mapping');
                }
                function u() {
                    if (s())
                        return !0;
                    ...
                    if (o.type == 'none')
                        return ot(e), !1;
                    if (o.type == 'partial')
                        return rt && window.clearTimeout(rt), rt = window.setTimeout(function () {
    ...
    st.prototype.pushRepeatDigit = function (e) {
        ...
        if (this.prefixRepeat.length > 0 || this.motionRepeat.length > 0)
            e = 1, this.prefixRepeat.length > 0 && (e *= parseInt(this.prefixRepeat.join(''), 10)), this.motionRepeat.length > 0 && (e *= parseInt(this.motionRepeat.join(''), 10));
        return e;
    }, ut.prototype = {
    ...
    var lt = {
            matchCommand: function (e, t, n, r) {
                ...
                return s.keys.slice(-11) == '<character>' && (n.selectedCharacter = Tt(e)), {
                    type: 'full',
                    command: s
                };
            },
            ...
            processEx: function (e, t, n) {
                ...
                function i(t, n, r) {
                    ...
                    if (i == 'Esc' || i == 'Ctrl-C' || i == 'Ctrl-[' || i == 'Backspace' && n == '')
                        tt.exCommandHistoryController.pushInput(n), tt.exCommandHistoryController.reset(), v.e_stop(t), ot(e), r(), e.focus();
                        ...
                        if (N) {
                            ...
                            if (C == 'block')
                                for (var A = 0; A < L.length; A++)
                                    L[A].head.ch = _t(e, L[A].head.line);
                            else
                                C == 'line' && (L[0].head = w(L[0].head.line + 1, 0));
                        }
                    } else {
                        x = Ct(d || h), T = Ct(p || c);
                        if (Lt(T, x)) {
            ...
            moveToMiddleLine: function (e) {
                var t = Mn(e), n = Math.floor((t.top + t.bottom) * 0.5);
            ...
            moveToOtherHighlightedEnd: function (e, t, n, r) {
                if (r.visualBlock && n.sameLine) {
                    var i = r.sel;
                    return [
                        yt(e, w(i.anchor.line, i.head.ch)),
                        yt(e, w(i.head.line, i.anchor.ch))
                    ];
                }
                return [
                    r.sel.head,
            ...
            textObjectManipulation: function (e, t, n, r) {
                ...
                return e.state.vim.visualMode ? Rt(e, a.start, a.end) : [
                    a.start,
                    a.end
                ];
            },
            ...
            enterInsertMode: function (e, t, n) {
                ...
                if (r == 'eol')
                    s = w(s.line, _t(e, s.line));
                else if (r == 'charAfter')
                    s = wt(s, 0, 1);
                else if (r == 'firstNonBlank')
                    s = ct.moveToFirstNonWhiteSpaceCharacter(e, s);
                else if (r == 'startOfSelectedArea')
                    n.visualBlock ? (s = w(Math.min(i.head.line, i.anchor.line), Math.min(i.head.ch, i.anchor.ch)), o = Math.abs(i.head.line - i.anchor.line) + 1) : i.head.line < i.anchor.line ? s = i.head : s = w(i.anchor.line, 0);
                else if (r == 'endOfSelectedArea')
                    n.visualBlock ? (s = w(Math.min(i.head.line, i.anchor.line), Math.max(i.head.ch + 1, i.anchor.ch)), o = Math.abs(i.head.line - i.anchor.line) + 1) : i.head.line >= i.anchor.line ? s = wt(i.head, 0, 1) : s = w(i.anchor.line, 0);
            ...
            paste: function (e, t, n) {
                ...
                if (n.visualMode) {
                    ...
                    e.replaceRange(s, r), p && t.after ? m = w(r.line + 1, Jt(e.getLine(r.line + 1))) : p && !t.after ? m = w(r.line, Jt(e.getLine(r.line))) : !p && t.after ? (g = e.indexFromPos(r), m = e.posFromIndex(g + s.length - 1)) : (g = e.indexFromPos(r), m = e.posFromIndex(g + s.length));
    ...
    var Pn = {
            ...
            registers: function (e, t) {
                ...
                if (!n)
                    ...
                    for (var u = 0; u < n.length; u++) {
                        s = n.charAt(u);
                        if (!tt.registerController.isValidRegister(s))
                            continue;
                        var a = r[s] || new ut();
                        i += '"' + s + '    ' + a.toString() + '<br>';
                    }
            ...
            substitute: function (e, t) {
                ...
                if (r.length)
                    i = r[0], s = r[1], s !== undefined && (Q('pcre') ? s = yn(s) : s = gn(s), tt.lastSubstituteReplacePart = s), o = r[2] ? r[2].split(' ') : [];
                else if (n && n.length) {
    ...
    t.handler = {
        ...
        handleKeyboard: function (e, t, n, r, i) {
            ...
            if (n == 'c' && t == 1) {
                ...
                u.insertMode || c.isMac && this.handleMacRepeat(e, t, n) && (t = -1, n = e.inputChar);
        ...
        updateMacCompositionHandlers: function (e, t) {
            var n = function (t) {
                    ...
                    if (!r.insertMode) {
                        ...
                        this.onCompositionUpdateOrig(t);
                }, r = function (t) {
                    var n = e.state.cm, r = rr(n);
    ...
    }, t.handler.defaultKeymap = b, t.handler.actions = mt, t.Vim = E, E.map('Y', 'yy', 'normal');
});