...
define('ace/snippets', [
    ...
    f.prototype = {
        ...
        $updateTabstops: function (e) {
            var t = 1000, n = 0, r = null, i = u.require('range'), s = u.require('tabStops'), o = u.require('resources').getVocabulary('user'), a = {
                    tabstop: function (e) {
    ...
    t.commands = new r(), t.runEmmetCommand = function (e) {
        try {
            ...
            if (this.action == 'expand_abbreviation_with_tab' && !e.selection.isEmpty())
                return !1;
