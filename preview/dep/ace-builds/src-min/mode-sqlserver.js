...
define('ace/mode/doc_comment_highlight_rules', [
    ...
    r.inherits(o, s), function () {
        this.foldingStartMarker = /(\bCASE\b|\bBEGIN\b)|^\s*(\/\*)/i, this.startRegionRe = /^\s*(\/\*|--)#?region\b/, this.getFoldWidgetRange = function (e, t, n, r) {
            ...
            if (s) {
                var o = s.index;
                if (s[1])
                    return this.getBeginEndBlock(e, n, o, s[1]);
                var u = e.getCommentFoldRange(n, o + s[0].length, 1);
                return u && !u.isMultiLine() && (r ? u = this.getSectionRange(e, n) : t != 'all' && (u = null)), u;
            }
            if (t === 'markbegin')
            ...
            var s = {
                    row: t,
                    column: n + r.length
                }, o = e.getLength(), u, a = 1, f = /(\bCASE\b|\bBEGIN\b)|(\bEND\b)/i;
            while (++t < o) {
                u = e.getLine(t);
                var l = f.exec(u);
                if (!l)
            ...
            var c = t;
            if (c > s.row)
                return new i(s.row, s.column, c, u.length);
        };
    }.call(o.prototype);
    ...
    'use strict';
    var r = e('../lib/oop'), i = e('./text').Mode, s = e('./sqlserver_highlight_rules').SqlHighlightRules, o = e('../range').Range, u = e('./folding/sqlserver').FoldMode, a = function () {
            this.HighlightRules = s, this.foldingRules = new u();
        };
