define('ace/mode/doc_comment_highlight_rules', [
    ...
    (function () {
        this.getFoldWidget = function (e, t, n) {
            ...
            if (!i) {
                var f = new u(e, n, r.start.column), l = {
                        row: n,
                ...
                var f = new u(e, n, r.end.column), c = {
                        row: n,
    ...
    'use strict';
    var r = e('../lib/oop'), i = e('../lib/lang'), s = e('./text').Mode, o = e('./javascript').Mode, u = e('./css').Mode, a = e('./html_highlight_rules').HtmlHighlightRules, f = e('./behaviour/xml').XmlBehaviour, l = e('./folding/html').FoldMode, c = e('./html_completions').HtmlCompletions, h = e('../worker/worker_client').WorkerClient, p = [
            'area',
            'base',
            'br',
            'col',
    ...
    r.inherits(u, i), function () {
        this.foldingStartMarker = /\b(function|then|do|repeat)\b|{\s*$|(\[=*\[)/, this.foldingStopMarker = /\bend\b|^\s*}|\]=*\]/, this.getFoldWidget = function (e, t, n) {
            ...
            if (i)
                return i[1] ? this.luaBlock(e, n, i.index + 1) : i[2] ? e.getCommentFoldRange(n, i.index + 1) : this.openingBracketBlock(e, '{', n, i.index);
            var i = this.foldingStopMarker.exec(r);
            if (i)
                return i[0] === 'end' && e.getTokenAt(n, i.index + 1).type === 'keyword' ? this.luaBlock(e, n, i.index + 1) : i[0][0] === ']' ? e.getCommentFoldRange(n, i.index + 1) : this.closingBracketBlock(e, '}', n, i.index + i[0].length);
