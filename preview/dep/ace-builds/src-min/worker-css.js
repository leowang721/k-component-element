    ...
    (function () {
        ...
        Combinator.prototype = new SyntaxUnit(), Combinator.prototype.constructor = Combinator, MediaFeature.prototype = new SyntaxUnit(), MediaFeature.prototype.constructor = MediaFeature, MediaQuery.prototype = new SyntaxUnit(), MediaQuery.prototype.constructor = MediaQuery, Parser.DEFAULT_TYPE = 0, Parser.COMBINATOR_TYPE = 1, Parser.MEDIA_FEATURE_TYPE = 2, Parser.MEDIA_QUERY_TYPE = 3, Parser.PROPERTY_NAME_TYPE = 4, Parser.PROPERTY_VALUE_TYPE = 5, Parser.PROPERTY_VALUE_PART_TYPE = 6, Parser.SELECTOR_TYPE = 7, Parser.SELECTOR_PART_TYPE = 8, Parser.SELECTOR_SUB_PART_TYPE = 9, Parser.prototype = function () {
            var e = new EventTarget(), t, n = {
                    ...
                    _import: function (e) {
                        var t = this._tokenStream, n, r, i, s = [];
                        t.mustMatch(Tokens.IMPORT_SYM), i = t.token(), this._readWhitespace(), t.mustMatch([
                            Tokens.STRING,
                            Tokens.URI
                        ]), r = t.token().value.replace(/^(?:url\()?["']?([^"']+?)["']?\)?$/, '$1'), this._readWhitespace(), s = this._media_query_list(), t.mustMatch(Tokens.SEMICOLON), this._readWhitespace(), e !== !1 && this.fire({
                            type: 'import',
                            uri: r,
                            media: s,
                            line: i.startLine,
                    ...
                    _namespace: function (e) {
                        var t = this._tokenStream, n, r, i, s;
                        t.mustMatch(Tokens.NAMESPACE_SYM), n = t.token().startLine, r = t.token().startCol, this._readWhitespace(), t.match(Tokens.IDENT) && (i = t.token().value, this._readWhitespace()), t.mustMatch([
                            Tokens.STRING,
                            Tokens.URI
                        ]), s = t.token().value.replace(/(?:url\()?["']([^"']+)["']\)?/, '$1'), this._readWhitespace(), t.mustMatch(Tokens.SEMICOLON), this._readWhitespace(), e !== !1 && this.fire({
                            type: 'namespace',
                            prefix: i,
                            uri: s,
                            line: n,
                    ...
                    _margin_sym: function () {
                        ...
                        ]) ? SyntaxUnit.fromToken(e.token()) : null;
                    },
                    ...
                    _combinator: function () {
                        ...
                        return e.match([
                            ...
                            Tokens.GREATER,
                            Tokens.TILDE
                        ]) && (n = e.token(), t = new Combinator(n.value, n.startLine, n.startCol), this._readWhitespace()), t;
                    },
                    ...
                    _namespace_prefix: function () {
                        ...
                        if (e.LA(1) === Tokens.PIPE || e.LA(2) === Tokens.PIPE)
                            e.match([
                                Tokens.IDENT,
                                Tokens.STAR
                            ]) && (t += e.token().value), e.mustMatch(Tokens.PIPE), t += '|';
                        return t.length ? t : null;
                    },
                    _universal: function () {
                        var e = this._tokenStream, t = '', n;
                    ...
                    _attrib: function () {
                        ...
                        return e.match(Tokens.LBRACKET) ? (r = e.token(), t = r.value, t += this._readWhitespace(), n = this._namespace_prefix(), n && (t += n), e.mustMatch(Tokens.IDENT), t += e.token().value, t += this._readWhitespace(), e.match([
                            Tokens.PREFIXMATCH,
                            Tokens.SUFFIXMATCH,
                            ...
                            Tokens.INCLUDES,
                            Tokens.DASHMATCH
                        ]) && (t += e.token().value, t += this._readWhitespace(), e.mustMatch([
                            Tokens.IDENT,
                            Tokens.STRING
                        ]), t += e.token().value, t += this._readWhitespace()), e.mustMatch(Tokens.RBRACKET), new SelectorSubPart(t + ']', 'attribute', r.startLine, r.startCol)) : null;
                    },
                    _pseudo: function () {
                        var e = this._tokenStream, t = null, n = ':', r, i;
                    ...
                    _term: function (e) {
                        ...
                        return n = this._unary_operator(), n !== null && (o = t.token().startLine, u = t.token().startCol), t.peek() == Tokens.IE_FUNCTION && this.options.ieFilters ? (r = this._ie_function(), n === null && (o = t.token().startLine, u = t.token().startCol)) : e && t.match([
                            Tokens.LPAREN,
                            Tokens.LBRACE,
                            Tokens.LBRACKET
                        ]) ? (s = t.token(), i = s.endChar, r = s.value + this._expr(e).text, n === null && (o = t.token().startLine, u = t.token().startCol), t.mustMatch(Tokens.type(i)), r += i, this._readWhitespace()) : t.match([
                            Tokens.NUMBER,
                            Tokens.PERCENTAGE,
                            Tokens.LENGTH,
                            Tokens.ANGLE,
        ...
        var ValidationTypes = {
                ...
                complex: {
                    ...
                    '<flex>': function (e) {
                        ...
                        if (!n)
                            throw t = e.peek(), new ValidationError('Expected (none | [ <flex-grow> <flex-shrink>? || <flex-basis> ]) but found \'' + e.value.text + '\'.', t.line, t.col);
                        return n;
                    }
                }
            };
