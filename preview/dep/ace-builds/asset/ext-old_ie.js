...
define('ace/ext/old_ie', [
    ...
    patch(TokenizerModule, 'Tokenizer', 'ruleRegExps.push(adjustedregex);\n', function (m) {
        return m + '        if (state[i].next && RegExp(adjustedregex).test(""))\n            rule._qre = RegExp(adjustedregex, "g");\n        ';
    });
