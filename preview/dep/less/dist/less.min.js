        ...
        1: [
            function (a, b) {
                ...
                b.exports = function (a, b) {
                    c(b, d.currentScript(a)), void 0 === b.isFileProtocol && (b.isFileProtocol = /^(file|(chrome|safari)(-extension)?|resource|qrc|app):/.test(a.location.protocol)), b.async = b.async || !1, b.fileAsync = b.fileAsync || !1, b.poll = b.poll || (b.isFileProtocol ? 1000 : 1500), b.env = b.env || ('127.0.0.1' == a.location.hostname || '0.0.0.0' == a.location.hostname || 'localhost' == a.location.hostname || a.location.port && a.location.port.length > 0 || b.isFileProtocol ? 'development' : 'production');
                ...
                b.exports = function (a, b, e) {
                    function f(b, f) {
                        ...
                        b.extract && (o(b, 0, ''), o(b, 1, 'line'), o(b, 2, ''), h += 'on line ' + b.line + ', column ' + (b.column + 1) + ':</p><ul>' + l.join('') + '</ul>'), b.stack && (b.extract || e.logLevel >= 4) && (h += '<br/>Stack Trace</br />' + b.stack.split('\n').slice(1).join('<br/>')), k.innerHTML = h, d.createCSS(a.document, [
                            ...
                            '}'
                        ].join('\n'), { title: 'error-message' }), k.style.cssText = [
                    ...
                    return n.watch = function () {
                        ...
                        return new Promise(function (a) {
                            ...
                            for (var c = 0; b.length > c; c++)
                                ('stylesheet/less' === b[c].rel || b[c].rel.match(/stylesheet/) && b[c].type.match(t)) && n.sheets.push(b[c]);
                            a();
                        });
            ...
            function (a, b) {
                var c = a('../logger'), d = function (a, b) {
                        ...
                        for (var c = [
                                ...
                                ], d = [], e = d.concat(c), f = 0; e.length > f; f++) {
                            var g = e[f], h = a[g];
            ...
            function (a) {
                ...
                f = {
                    ...
                    hsla: function (a, c, e, g) {
                        ...
                        var i = 0.5 >= e ? e * (c + 1) : e + c - e * c, j = 2 * e - i;
                    ...
                    mix: function (a, b, c) {
                        ...
                        var d = c.value / 100, e = 2 * d - 1, f = a.toHSL().a - b.toHSL().a, i = ((e * f == -1 ? e : (e + f) / (1 + e * f)) + 1) / 2, j = 1 - i, k = [
                                a.rgb[0] * i + b.rgb[0] * j,
                                a.rgb[1] * i + b.rgb[1] * j,
                                a.rgb[2] * i + b.rgb[2] * j
                    ...
                    contrast: function (a, b, c, e) {
                        ...
                        return e = 'undefined' == typeof e ? 0.43 : d(e), a.luma() < e ? c : b;
                    },
                    argb: function (a) {
            ...
            function (a, b) {
                var c = a('./utils'), d = b.exports = function (a, b, d) {
                        ...
                        if (b && e) {
                            ...
                            this.type = a.type || 'Syntax', this.filename = e, this.index = a.index, this.line = 'number' == typeof h ? h + 1 : null, this.callLine = j + 1, this.callExtract = k[j], this.column = i, this.extract = [
                                k[h - 1],
                                k[h],
                                k[h + 1]
                            ];
                                ...
                                multiplication: function () {
                                    ...
                                    if (a = this.operand()) {
                                        for (f = o.isWhitespace(-1);;) {
                                            ...
                                            o.forget(), a.parensInOp = !0, b.parensInOp = !0, e = new d.Operation(c, [
                                                e || a,
                                                b
                                            ], f), f = o.isWhitespace(-1);
                                        }
                                        return e || a;
                                    }
                                },
                                    ...
                                    if (a = this.multiplication()) {
                                        for (f = o.isWhitespace(-1);;) {
                                            ...
                                            if (b = this.multiplication(), !b)
                                                break;
                                            a.parensInOp = !0, b.parensInOp = !0, e = new d.Operation(c, [
                                                e || a,
                                                b
                                            ], f), f = o.isWhitespace(-1);
                                        }
        ...
        48: [
            function (a, b) {
                ...
                g.prototype = new e(), g.prototype.type = 'Color', g.prototype.luma = function () {
                    ...
                    return a = 0.03928 >= a ? a / 12.92 : Math.pow((a + 0.055) / 1.055, 2.4), b = 0.03928 >= b ? b / 12.92 : Math.pow((b + 0.055) / 1.055, 2.4), c = 0.03928 >= c ? c / 12.92 : Math.pow((c + 0.055) / 1.055, 2.4), 0.2126 * a + 0.7152 * b + 0.0722 * c;
                    ...
                    return f.hasOwnProperty(c) ? b = new g(f[c].slice(1)) : 'transparent' === c && (b = new g([
                        0,
                        0,
                        0
                    ], 0)), b ? (b.value = a, b) : void 0;
                }, b.exports = g;
            },
            {
                '../data/colors': 11,
        ...
        54: [
            function (a, b) {
                ...
                g.prototype = new c(), g.prototype.type = 'Dimension', g.prototype.accept = function (a) {
                    ...
                    if (0 !== c && 0.000001 > c && c > -0.000001 && (d = c.toFixed(20).replace(/0+$/, '')), a && a.compress) {
                    ...
                    function b(b, c) {
                        ...
                        for (k = 0; 2 > k; k++) {
                            for (w[k] = !0, f.value(k), d = 0; c.length > d && w[k]; d++)
                                e = c[d], e.matchCondition && (w[k] = w[k] && e.matchCondition(null, a));
        ...
        66: [
            function (a, b) {
                ...
                i.prototype = new e(), i.prototype.type = 'MixinDefinition', i.prototype.evalFirst = !0, i.prototype.accept = function (a) {
                    ...
                    return l.prependRule(new f('@arguments', new g(j).eval(a))), d = this.rules.slice(0), i = new e(null, d), i.originalRuleset = this, i = i.eval(new h.Eval(a, [
                        this,
                        l
                    ].concat(k))), c && (i = i.makeImportant()), i;
        ...
        67: [
            function (a, b) {
                ...
                f.prototype = new c(), f.prototype.type = 'Negative', f.prototype.genCSS = function (a, b) {
                    ...
                    return a.isMathOn() ? new d('*', [
                        new e(-1),
                        this.value
                    ]).eval(a) : new f(this.value.eval(a));
                }, b.exports = f;
            },
            {
                './dimension': 54,
                ...
                l.prototype = new c(), l.prototype.type = 'Ruleset', l.prototype.isRuleset = !0, l.prototype.isRulesetLike = !0, l.prototype.accept = function (a) {
                    ...
                    for (f = 0; s > f; f++)
                        'MixinCall' === r[f].type ? (n = r[f].eval(a).filter(function (a) {
                            ...
                            f,
                            1
                        ].concat(n)), s += n.length - 1, f += n.length - 1, o.resetCache()) : 'RulesetCall' === r[f].type && (n = r[f].eval(a).rules.filter(function (a) {
                            return a instanceof d && a.variable ? !1 : !0;
                        }), r.splice.apply(r, [
                            f,
                            1
                        ].concat(n)), s += n.length - 1, f += n.length - 1, o.resetCache());
                    ...
                    if (d)
                        for (b = 0; d.length > b; b++)
                            'Import' === d[b].type && (c = d[b].eval(a), c && c.length ? (d.splice.apply(d, [
                                b,
                                1
                    ...
                    _mergeRules: function (a) {
                        if (a) {
                            for (var b, d, e, f = {}, g = 0; a.length > g; g++)
                                d = a[g], d instanceof c.Rule && d.merge && (e = [
                                    d.name,
                                    d.important ? '!' : ''
