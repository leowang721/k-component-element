...
(function (f) {
    ...
    return function e(t, n, r) {
        ...
        23: [
            function (require, module, exports) {
                var Dimension = require('../tree/dimension'), functionRegistry = require('./function-registry');
                var mathFunctions = {
                        ceil: null,
                        floor: null,
                        sqrt: null,
        ...
        24: [
            function (require, module, exports) {
                var Dimension = require('../tree/dimension'), Anonymous = require('../tree/anonymous'), functionRegistry = require('./function-registry');
            ...
            function (require, module, exports) {
                ...
                ImportVisitor.prototype = {
                    ...
                    onImported: function (importNode, context, e, root, importedAtRoot, fullPath) {
                        ...
                        var importVisitor = this, inlineCSS = importNode.options.inline, isPlugin = importNode.options.plugin, duplicateImport = importedAtRoot || fullPath in importVisitor.recursionDetector;
